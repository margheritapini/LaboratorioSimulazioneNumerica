...
void System :: averages(int blk){
  ...
  if (_measure_pressure) _average(_index_pressure) += _rho*_measurement(_index_temp);
  _global_av  += _average;
  ...
  if (_measure_tenergy){
    ...
    if (blk==_nblocks) {
    	coutf.open("../OUTPUT/total_energy_final.dat",ios::app);
    	coutf << setw(12) << _temp
          << setw(18) << scientific << sum_average/double(blk)
          << setw(18) << scientific << this->error(sum_average, sum_ave2, blk) << endl;
    coutf.close();
  ...
  // MAGNETIZATION /////////////////////////////////////////////////////////////
   if (_measure_magnet){
    ...
    if (blk==_nblocks) {
    	coutf.open("../OUTPUT/magnetization_final.dat",ios::app);
    	coutf << setw(12) << _temp
          << setw(18) << scientific << sum_average/double(blk)
          << setw(18) << scientific << this->error(sum_average, sum_ave2, blk) << endl;
    coutf.close();
  ...
  // SPECIFIC HEAT /////////////////////////////////////////////////////////////
    ...
    if (blk==_nblocks) {
    	coutf.open("../OUTPUT/specific_heat_final.dat",ios::app);
    	coutf << setw(12) << _temp
          << setw(18) << scientific << sum_average/double(blk)
          << setw(18) << scientific << this->error(sum_average, sum_ave2, blk) << endl;
    coutf.close();
  ...
  // SUSCEPTIBILITY ////////////////////////////////////////////////////////////
   if (_measure_chi){
    ...
    if (blk==_nblocks) {
    	coutf.open("../OUTPUT/susceptibility_final.dat",ios::app);
    	coutf << setw(12) << _temp
          << setw(18) << scientific << sum_average/double(blk)
          << setw(18) << scientific << this->error(sum_average, sum_ave2, blk) << endl;
    coutf.close();
