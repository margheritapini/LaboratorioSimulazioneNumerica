...
public: // Function declarations
	void change_temp(double decrease);
  ...
  void initialize_different_T(); // Define files to store the measurements obtained with different T
  ...
  int gibbs(int part);			// Perform a Gibbs step to choose the spin
  ...
  void choose_delta (System &SYS, double accepted_fraction);
